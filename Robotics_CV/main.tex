...
\item Built a low-cost ($<$\$1,200 including onboard compute) bimanual manipulator testbed inspired by Mobile ALOHA, targeting efficient policy learning with world model verifiers and human-in-the-loop intervention for rapid policy refinement
