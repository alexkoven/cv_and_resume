...
\item Built a low-cost bimanual manipulator testbed inspired by Mobile ALOHA ($<$\$1,200 including onboard compute), targeting efficient policy learning with world model verifiers and human-in-the-loop intervention for rapid policy refinement
