...
\item Built low-cost (under \$1,200 including onboard compute) bimanual manipulator testbed designed for rapid imitation learning iterations; enabling efficient policy learning with world model verifiers
...
Research in data-driven control (Predictive Iterative Learning Control) and computer vision for advanced manufacturing processes and robotics applications. \\
