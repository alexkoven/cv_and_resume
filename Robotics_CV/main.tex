...
% Visiting Undegraduate Research Scholar
...
Systematic deployment and evaluation of state-of-the-art robot foundation models (VLA models, World Action Models) in simulation and on a low-cost bimanual manipulation testbed; benchmarking \(\pi\)0.5, DreamZero (14B WAM), SmolVLA, ACT, and diffusion policies across standardized task suites in DROID (Isaac Sim/Lab); developing and deploying imitation-learned policies with world model verifiers to enable data-efficient real-world operation. \\

09/2022 -- 06/2025 &
\textbf{Multi AI, Inc.}, Austin, TX / San Francisco, CA -- \textbf{Co-Founder \& CEO} \newline
Grew company from PhD-stage prototype to Pentagon-contracted product; built a multi-agent reinforcement learning platform for safety-critical decision-making in adversarial environments, outperforming baseline by 38\% in field evaluations; final product included an RL pipeline (PPO) warm-started from imitation learning with expert demonstrations, and a human-machine interface with large language and vision models. \\

11/2021 -- 09/2022 &
\textbf{Droneconia LLC} (later Multi AI, Inc.), Austin, TX -- \textbf{Co-Founder \& Chief Technology Officer} \newline
Designed and implemented multi-agent RL and Monte Carlo tree search (MCTS) architectures for autonomous UAV/UGV motion and mission planning (10--30 vehicles, scaled to 100+); secured and delivered Air Force SBIR Phase I contract from AFWERX Agility Prime for decision-support AI under adversarial conditions. \\

01/2019 -- 12/2022 &
\textbf{Autonomous Systems Group}, UT Austin -- \textbf{NSF-Supported Researcher} \newline
Graduate research in autonomous systems and formal methods (NSF CPS project, Caltech, Berkeley, Northeastern, RPI); designed and commissioned novel hardware testbeds including the world's first aerial 3D printing hexacopter, building custom MPC and feedback control algorithms for in-flight FDM deposition (5.43\,mm RMSE); developed learning-based algorithms including data-driven perception and control pipelines for manufacturing and learned motion planning policies for agile ground and aerial platforms; published at IROS, ICUAS, IEEE CDC, ICMLA, and SFF. \\

08/2016 -- 12/2018 &
\textbf{Advanced Manufacturing Center}, UT Austin -- \textbf{Research Assistant} \newline
Designed and commissioned hardware testbeds for advanced manufacturing processes; developed data-driven control and anomaly detection pipelines for automated process monitoring. \\

01/2016 -- 04/2016 &
\textbf{Mercedes-Benz}, Stuttgart, Germany -- \textbf{Robot Operations Intern} \newline
ABB robotic assembly optimization for the OM-651 diesel engine at Daimler headquarters. \\

11/2015 -- 12/2015 &
\textbf{Ford Germany}, Cologne, Germany -- \textbf{Maintenance Intern} \newline
Maintenance and fault diagnosis of ABB industrial robots in aluminum die casting production. \\
...
Signal detection for Electrohydrodynamic Jet (e-jet) printing in Prof. Kira Barton's lab. \\
...
& \textbf{Robotics \& Control:} Reinforcement Learning (PPO), Perception (SLAM, VIO), Motion Planning (trajectory generation, trajectory optimization), State Estimation (Kalman Filters, EKF, EKF2), Feedback Control (PID, Optimal Control, Nonlinear Control), Model Predictive Control (MPC) \\

& \textbf{VLA \& Foundation Models:} \(\pi\)0.5, SmolVLA, DreamZero, ACT, Diffusion Policies, Imitation Learning (DAgger, teacher-student learning), Sim-to-Real Transfer \\

& \textbf{Programming \& Tools:} Python, C++, PyTorch, ROS2, Isaac Sim/Isaac Lab, Git \\

& \textbf{Leadership \& Outreach:} Team building and hiring (startup co-founder); government program management and stakeholder communication (DoD, AFWERX, Air Force AFRL); SBIR proposal writing (Phase I/II/III); research mentorship (20+ undergraduates); guest lecturer, UT Austin; STEM outreach instructor; Languages: German (native), English (fluent) \\
