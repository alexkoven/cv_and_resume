...
\item Systematic deployment and evaluation of robot foundation models (VLA models, World Action Models) in simulation and on physical hardware
\item Building and deploying learned policies on a low-cost bimanual manipulator; benchmarking policy performance and identifying failure sources
\end{itemize} \\

09/2022 -- 06/2025 &
\textbf{Multi AI, Inc.}, Austin, TX / San Francisco, CA -- \textbf{Co-Founder \& CEO}
\begin{itemize}[noitemsep, topsep=2pt]
\item Built multi-agent AI platform (decentralized MCTS + generative AI) for adaptive decision-making under adversarial conditions, outperforming baseline by 38\% in field evaluations
\item Owned full AI development lifecycle from architecture through government delivery; grew company from PhD-stage prototype to Pentagon-contracted product
\end{itemize} \\

11/2021 -- 09/2022 &
\textbf{Droneconia LLC} (later Multi AI, Inc.), Austin, TX -- \textbf{Co-Founder \& CTO}
\begin{itemize}[noitemsep, topsep=2pt]
\item Designed and implemented the initial multi-agent AI architecture for autonomous UAV/UGV mission planning; secured and delivered Air Force SBIR Phase I contract from AFWERX Agility Prime
\end{itemize} \\

01/2019 -- 12/2022 &
\textbf{Autonomous Systems Group}, UT Austin -- \textbf{NSF-Supported Researcher}
\begin{itemize}[noitemsep, topsep=2pt]
\item End-to-end system engineering of the world's first aerial 3D printing hexacopter; designed and commissioned novel hardware testbeds from scratch
\item Developed learning-based algorithms for multiple robot morphologies as part of an NSF CPS project spanning Caltech, UC Berkeley, Northeastern, and RPI
\item Published at IROS, ICUAS, IEEE CDC, ICMLA, and SFF; mentored 20+ undergraduate researchers
\end{itemize} \\
