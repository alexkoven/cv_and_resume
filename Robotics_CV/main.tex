...
\item Built low-cost ($<$\$1,200 including onboard compute) bimanual manipulator testbed designed for rapid imitation learning iterations; goal is to enable efficient policy learning with world model verifiers
...
& \textbf{Programming \& Tools:} Python, C++, PyTorch, ROS2, Isaac Sim/Isaac Lab, Embedded Systems, Docker, Linux, Edge Deployment, Systems Design, Git \\
