...
Systematic evaluation of state-of-the-art robot foundation models (VLA models, World Action Models) in simulation and on a low-cost bimanual manipulator; benchmarking policy performance and identifying failure sources. \\

09/2022 -- 06/2025 &
\textbf{Multi AI, Inc.}, Austin, TX / San Francisco, CA -- \textbf{Co-Founder \& CEO} \newline
Grew company from PhD-stage prototype to Pentagon-contracted product; built multi-agent AI platform (decentralized MCTS + generative AI) achieving 38\% improvement in disrupted logistics scenarios. \\

11/2021 -- 09/2022 &
\textbf{Droneconia LLC} (later Multi AI, Inc.), Austin, TX -- \textbf{Co-Founder \& Chief Technology Officer} \newline
Designed initial multi-agent AI algorithms for autonomous UAV/UGV mission planning; secured and delivered Air Force SBIR Phase I contract from AFWERX Agility Prime. \\

01/2019 -- 12/2022 &
\textbf{Autonomous Systems Group}, UT Austin -- \textbf{NSF-Supported Researcher} \newline
Research on autonomous systems and robotics in NSF-funded collaboration with Caltech, Berkeley, Northeastern, and RPI.\\
...
2018-2020 & \textbf{National Science Foundation (NSF)-Supported Researcher}. Selected researcher on multi-year project with CalTech, Berkeley, Northeastern, and RPI. \\
